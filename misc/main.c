...
/*   Updated: 2020/12/28 15:12:16 by gcc              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
printf("\nprintf(\"%%010x\", 542)\n");
	...
	printf("\nprintf(\"%%D\", LONG_MAX)\n");
	i = ft_printf("%ld", LONG_MAX);
	printf(" -> %d for my PF\n", i);
	j = printf("%ld", LONG_MAX);
	printf(" -> %d for LIBC PF\n", j);
	printf("\nprintf(\"{%%5p}\", 0) \n");
	i = ft_printf("{%5p}", 0);
	printf(" -> %d for my PF\n", i);
...
printf("\nprintf(\"{%% s}\", L\"(null)\")\n");
	...
	printf("\nprintf(\"%%.4ls\", L\"我是一只猫。\")\n");
	i = ft_printf("%.4ls", L"我是一只猫。");
	printf(" -> %d for my PF\n", i);
	j = printf("%.4ls", L"我是一只猫。");
	printf(" -> %d for LIBC PF\n", j);
printf("\nprintf(\"{%%05p}\", 0)\n");
	i = ft_printf("{%05p}", 0);
	printf(" -> %d for my PF\n", i);
...
//printf("\nprintf(\"%%5+d\", 42)\n");
	...
	printf(" -> %d for LIBC PF\n", j);
	i = ft_printf("%4.ls", L"我是一只猫。");
	printf(" -> %d for my PF\n", i);
	j = printf("%4.ls", L"我是一只猫。");
	printf(" -> %d for LIBC PF\n", j);
	//	printf("\nprintf(\"{%%05p}\", 0)\n");   // OK as undefined
	j = printf("{%05p}", 0);
	printf(" -> %d for LIBC PF\n", j);
	...
	printf("Moi %d Le vrai : %d\n", i, j);
	printf("\n-- string unicode --\n");
	i = ft_printf("Mon printf  : %ls\n", L"élodie");
	j = printf("Vrai printf : %ls\n", L"élodie");
	printf("Moi %d Le vrai : %d\n", i, j);
	printf("\nprintf(\"%%15.4ls\", L\"我是一只猫。\");\n");
	i = ft_printf("%15.4ls", L"我是一只猫。");
	printf(" -> %d for my PF\n", i);
	j = printf("%15.4ls", L"我是一只猫。");
	printf(" -> %d for LIBC PF\n", j);
	printf("\nprintf(\"%%ls\", L\"Á±≥\")\n");
	i = ft_printf("%ls", L"Á±≥");
	printf(" -> %d for my PF\n", i);
...
printf("\nprintf(\"{%%030S}\", L\"ÊM-M-^QÊM-^XØ‰∏M-ÂM-^O™ÁM-^L´„M-M-^B\")\n");
	...
	ft_printf("%s\n", L"잘했지 ?");
	i = ft_printf("blabla%d blabla %lc", 5, 1334567); // hardest test ?
	printf(" -> %d for my PF\n", i);
	j = printf("blabla%d blabla %lc", 5, 1234567);
	printf(" -> %d for LIBC PF\n", j);
	 i = 5;
	ft_printf("%p\n", &i);
	printf("%p\n", &i);
